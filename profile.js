document.querySelectorAll(".content-nav button").forEach(button => {
    button.addEventListener("click", () => {
        ...
        document.querySelectorAll(".content-title").forEach(s => s.classList.remove("active"));
        document.querySelectorAll(".content-nav button").forEach(btn => btn.classList.remove("active"))
